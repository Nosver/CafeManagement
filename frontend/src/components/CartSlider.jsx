...
const products = [
    ...
    },
    {
      ...
      imageAlt: 'Brown leather messenger bag with front and side pockets, adjustable shoulder strap, and silver buckle.',
    },
    {
      id: 4,
      name: 'Canvas Zip Tote Basket',
      href: '#',
      color: 'Gray',
      price: '$50.00',
      quantity: 1,
      imageSrc: 'https://tailwindui.com/img/ecommerce-images/shopping-cart-page-04-product-04.jpg',
      imageAlt: 'Gray canvas tote basket with black handles, zipper top, and side pocket.',
    },
    {
      id: 5,
      ...
      imageAlt: 'Black leather card holder with multiple slots and silver logo.',
    },

...
function MenuItem(props) {
  ...
  return (
    <>
      <div class="menu-item bg-white border border-gray-300 rounded-md mb-20 overflow-hidden">
        ...
        <div class="menu-item-info py-5">
          ...
          <button class="mb-5 mr-5 bg-custom-light-brown text-white py-2 px-4 rounded-md cursor-pointer float-right mt-2">Add to Cart</button>
        </div>
      </div>
    </>
  );

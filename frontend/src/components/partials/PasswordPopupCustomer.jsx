...
export const PasswordPopupCustomer = ({closePopup}) => {
    ...
    try {
      const response = await fetch('http://localhost:8080/customer_only/updatePassword', {
        method: 'POST',
        headers: {
                    ...
                    <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
                        ...
                        <div className="p-4 md:p-5">
                            ...
                            <form>
                                ...
                                type="submit" class="text-white bg-yellow-700 hover:bg-custom-brown focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Change Password
                                </button>
                            </form>

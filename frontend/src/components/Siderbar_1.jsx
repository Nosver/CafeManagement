            ...
            <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class={`h-full px-3 py-4 overflow-y-auto ${bg_color}`}>
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="/dashboard" className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                                <svg class={`w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:${text_color} dark:group-hover:text-white`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        ...
                        >
                            ...
                            <a className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                        ...
                        <li>
                            <a className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                                <svg class={`w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:${text_color} dark:group-hover:text-white`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                        ...
                        <li>
                            <a href="#" className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>

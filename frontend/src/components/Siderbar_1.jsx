                ...
                <div class={`h-full px-3 py-4 overflow-y-auto ${bg_color}`}>
                    <ul class="space-y-2 font-medium">
                        ...
                        <li onClick={() => navigate('/dashboard')}>
                            <a className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white ${hover_color} dark:hover:bg-gray-700 group`}>
                        ...
                        <li>
                            <a className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white ${hover_color} dark:hover:bg-gray-700 group`}>
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Users No</span>
                            </a>
                        </li>
                        <li>
                            <a className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white ${hover_color} dark:hover:bg-gray-700 group`}>
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Products No</span>
                            </a>
                        </li>
                        <li>
                            <a className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white ${hover_color} dark:hover:bg-gray-700 group`}>
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Sign In No</span>
                            </a>
                        </li>
                        <li>
                            <a className={`flex items-center p-2 ${text_color} rounded-lg dark:text-white ${hover_color} dark:hover:bg-gray-700 group`}>
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Sign Up No</span>
                            </a>
                        </li>
                    </ul>
                </div>

        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                ...
                <div class="flex justify-center items-center">
                    <h2 class="text-xl tracking-tight font-extrabold text-gray-900 dark:text-white flex items-center">
                        <a href="https://github.com/Nosver" class="text-gray-500 hover:text-gray-900 dark:hover:text-white flex items-center">
